...
resourcestring
  ...
  SSearchPanelApplyFilterEh = 'Montrer les enregistrements où le texte a été trouvé';
  SSearchPanelCancelFilterEh = 'Annuler le filtre et effacer le texte recherché';
  SSearchPanelFindNextEh = 'Chercher suivant';
  SSearchPanelFindPrevEh = 'Chercher précédent';
  SSearchPanelOptionsEh = 'Montrer les options de recherche';
