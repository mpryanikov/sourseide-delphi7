...
uses SysUtils, Windows, ComObj, Dialogs,
{$IFDEF CIL}
  EhLibVCLNET,
{$ELSE}
  EhLibVCL,
...
{$IFDEF EH_LIB_17} System.Types, {$ENDIF}
  Classes, Db, Contnrs, DBCommon, MemTreeEh, ToolCtrlsEh;
...
var
  ...
  procedure WriteRecordsList(Stream: TStream; List1: TRecordsListEh);
  var
    Writer: TWriter;
  begin
    Writer := TWriter.Create(Stream, 1024);
    try
      Writer.DefineProperty('Data', List1.ReadData, List1.WriteData, True);
    finally
      Writer.Free;
    end;
  end;
