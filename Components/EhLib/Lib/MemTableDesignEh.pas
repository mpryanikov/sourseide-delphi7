...
{                     EhLib v6.3                        }
{                                                       }
{     TMemTableFieldsEditorEh component (Build 6.3.04)  }
{                                                       }
...
{$ELSE}
  EhLibVCL,
{$ENDIF}
  Classes, Graphics, Controls, Forms, DesignMenus,
...
uses Clipbrd, MemTableEditEh, DataDriverEh, TypInfo, DBAxisGridsEh,
{$IFDEF CIL}
...
//  BDEDataDriverEh, BDEDataDriverDesignEh,
  SQLDriverEditEh, ToolsAPI, EhLibDesignAbout,
    ...
    3:
      begin
        ...
        begin
          ...
          GetComponentNames(lst, TDataDriverEh, False);
...
begin
  ...
  begin
    ...
    GetComponentNames(slAll, TDataSet, False);
